...
import ai.typesafe.sdk.SdkVersion;
...
import ai.typesafe.sdk.errors.NotFoundException;
import ai.typesafe.sdk.errors.PermissionDeniedException;
...
import ai.typesafe.sdk.errors.UnprocessableEntityException;
...
public final class Transport implements AutoCloseable {
    ...
    public interface Decoder<T> {
        /** Decodes the response; throw {@link ai.typesafe.sdk.errors.ResponseValidationException} when invalid. */
