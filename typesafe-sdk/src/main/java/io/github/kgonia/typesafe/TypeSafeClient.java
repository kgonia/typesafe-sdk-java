...
import io.github.kgonia.typesafe.internal.ClientConfig;
import io.github.kgonia.typesafe.internal.DefaultTypeSafeClient;
import io.github.kgonia.typesafe.internal.Environment;
...
public interface TypeSafeClient extends AutoCloseable {
     ...
     * @throws io.github.kgonia.typesafe.errors.TypeSafeApiException when the server returns an error after any retries
     * @throws io.github.kgonia.typesafe.errors.TypeSafeConnectionException when the request cannot complete after any retries
     * @throws io.github.kgonia.typesafe.errors.TypeSafeInterruptedException when the calling thread is interrupted
     */
    ...
    final class Builder {
        ...
        /** The logger to write to. Default: {@code System.getLogger("io.github.kgonia.typesafe")}. */
